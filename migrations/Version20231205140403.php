 ...
 */
final class Version20231205140403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE modele ADD marque_id INT NOT NULL, ADD image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE modele DROP marque_id, DROP image');
    }
}
